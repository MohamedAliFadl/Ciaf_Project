...
import BMItem from "../Container/BMItem";
          ...
          <div className="row">
            ...
            <div className="col-md-12">
              <div className="owl-testimonials owl-carousel">
                <BMItem img={Mohamed} name="Mohamed Heiba" title="Chairman" desc="Chairman & CEO of CIAF Holding of Civil aviation holding Company Support & Development Civil Aviation Fund (SADCAF)"/>
